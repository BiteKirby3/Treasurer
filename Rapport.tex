...
\begin{document}
	...
	\begin{figure}[H]
		\begin{center}
			...
			\captionof{figure}{\label{fig:gantt}Diagramme GANTT} 
		\end{center} 
	\end{figure}.
	...
	\begin{figure}[H]
		\begin{center}
			...
			\captionof{figure}{\label{fig:uml}Modèle UML} 
		\end{center} 
	\end{figure}.
	...
	\begin{itemize}
		...
		\begin{figure}[H]
			\begin{center}
				...
				\captionof{figure}{\label{fig:demarrerpostgres}Démarrer Postgres} 
			\end{center} 
		\end{figure}
		...
		\begin{figure}[H]
			\begin{center}
				...
				\captionof{figure}{\label{fig:ajouterbasededonnees}Ajouter base de données} 
			\end{center} 
		\end{figure}
		...
		\begin{figure}[H]
			\begin{center}
				...
				\captionof{figure}{\label{fig:configurationbuild}Configuration Build} 
			\end{center} 
		\end{figure}
	\end{itemize}
